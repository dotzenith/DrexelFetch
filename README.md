...
### ❖ Information 
  ...
  **NOTE**: The data is sourced directly from the `courses.csv` file in the `drexelfetch` package, and might be outdated in the future. The data was scraped by [@Shahriyar](https://github.com/ShahriyarShawon) and sanitized by [@Oscar](https://github.com/Cha0ticDr4gon), I just wrote a silly little python script on top to display it. 
